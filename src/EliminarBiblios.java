 ...
 * @author RANDY
 */
public class EliminarBiblios extends javax.swing.JFrame {
            CargaIndividual Ci = new CargaIndividual();
    /**
     * Creates new form EliminarBiblios
     */
    ...
    private void initComponents() {
        ...
        EliminarBiblio = new javax.swing.JButton();
        ...
        EliminarBiblio.setText("Eliminar Bibliografia");
        EliminarBiblio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EliminarBiblioActionPerformed(evt);
            }
        });
        ...
        Txt_PalabrasClave.setEditable(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(EliminarBiblio, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void EliminarBiblioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarBiblioActionPerformed
        // TODO add your handling code here:

        for (int i = 0; i < Ci.getListaBiblios().length; i++) {
            if(Ci.getListaBiblios()[i] != null){
                if(Ci.getListaBiblios()[i].getISBN().equals(Txt_Isbn.getText())){
                    Ci.getListaBiblios()[i] = null;
    ...
    }//GEN-LAST:event_EliminarBiblioActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarBiblios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarBiblios().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton EliminarBiblio;

...
public class ModificarUsuario extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(ModificarUsuarios, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(ModificarUsuarios, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ModificarUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarUsuariosActionPerformed
       ...
       if(Cu.hayEspacio(Cu.getListaUsuarios())){
           Cu.ListaUsuarios = Cu.redimensionarArreglo(Cu.getListaUsuarios());
        }
         
        for (int i = 0; i < Cu.getListaUsuarios().length; i++) {
            if(Cu.getListaUsuarios()[i] != null){
                Cu.getListaUsuarios()[i+1] = new DatosUsuarios(Txt_ID.getText(), Txt_Nombre.getText(), Txt_Apellido.getText(), Txt_Usuario.getText(), Txt_Rol.getText(), Txt_Contraseña.getText());
            break; 
    ...
    private void BuscarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarUsuarioActionPerformed
        ...
        for (int i = 0; i < Cu.getListaUsuarios().length; i++) {
            ...
            if(matriz[i][0].equals(Txt_ID.getText())){
            Txt_Nombre.setText(matriz[i][1]);
            Txt_Apellido.setText(matriz[i][2]);
            Txt_Usuario.setText(matriz[i][3]);
            Txt_Rol.setText(matriz[i][4]);
            Txt_Contraseña.setText(matriz[i][5]);

            for (int j = 0; j < Cu.getListaUsuarios().length; j++) {
                if(matriz[i][3]==Txt_Usuario.getText()){
                    x=1;
                }

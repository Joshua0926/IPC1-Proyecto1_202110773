 ...
 * @author RANDY
 */
public class BibliosCreadas extends javax.swing.JFrame {
        CargaIndividual Ci = new CargaIndividual();
    /**
     * Creates new form BibliosCreadas
     */
    public BibliosCreadas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Bibliografias creadas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BibliosCreadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BibliosCreadas().setVisible(true);
            }
        });
    }
